...
**Amendment Version**: 1.0.0 → 1.1.0

**Rationale**: Addition of Phase 3 (AI Chatbot Integration) extends constitution to cover multi-phase architecture with MCP tools and stateless chat server.

**Modified/Added Principles:**
- ✅ V. Context7 MCP: Added Phase 3 technologies (OpenAI Agents SDK, MCP SDK, ChatKit)
- ✅ **NEW: VII. Model Context Protocol (MCP)** - Phase 3 critical principle for tool-based operations
- ✅ VIII. Modular & Future-Ready: Updated to reference MCP server and Phase III readiness
- ✅ **NEW: X. AI Chatbot Integration** - Phase 3 specific principle

**New Major Sections:**
- ✅ Phase 2: Full-Stack Web App (reorganized)
- ✅ **NEW: Phase 3: Todo AI Chatbot** (comprehensive)
- ✅ Database Schema (extended with Conversation/Message tables)
- ✅ API Design Standards (added Phase 3 Chat endpoint)

**Templates Requiring Updates:**
- ✅ `@specs/templates/spec-template.md` - Add Phase 3 chatbot section
- ✅ `@specs/templates/plan-template.md` - Add MCP architecture section
- ✅ `@specs/templates/tasks-template.md` - Add MCP tool testing tasks
- ✅ `@specs/templates/adr-template.md` - Reference Phase 3 decisions
...
**Last Amended**: 2026-01-12 (Phase 3 Addition)
